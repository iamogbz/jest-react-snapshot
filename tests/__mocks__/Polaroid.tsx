...
// https://singlediv.com/#icon-polaroid
export const Polaroid = styled.div`
  ...
  // inset-inline-end: 224.5px;
  // inset-inline-start: 285.492px;
  isolation: auto;
  ...
  &::before {
    ...
    box-shadow:
      ...
      rgb(221, 221, 221) 40px -10px 0px -12px,
      rgb(0, 0, 0) 33px 12px 0px -10px,
      rgb(0, 0, 0) -37px 15px 0px -10px;
    box-sizing: content-box;
    break-after: auto;
    break-before: auto;
    break-inside: auto;
